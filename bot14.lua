...
while true do
    ...
    if pid_result == "" then
        ...
        -- ============================================================
        -- STRATEGI LAUNCH BARU: SPLIT SCREEN (MULTI-WINDOW)
        --
        -- Mengubah APK membutuhkan root tingkat dalam dan merusak signature.
        -- Sebagai solusi agar Termux dan Roblox bisa tampil bersamaan
        -- ("z 9999 di depan termux"), kita gunakan Split Screen Android.
        --
        -- Mode 4 (Split Screen Secondary) akan membuka Roblox di bawah,
        -- membiarkan Termux tetap berjalan di atas.
        -- ============================================================
        ...
        -- ===== TAHAP 1: Launch Split Screen + deep link =====
        print("📱 [Launch] Membuka Roblox dalam mode Split Screen...")
        local start_cmd = string.format(
            "am start --windowingMode 4 -a android.intent.action.VIEW -d '%s' -f 0x10000000 %s 2>&1",
            ps_link, pkg
        )
        ...
        if app_started then
            print("🪟 App berjalan di mode Split Screen (jika didukung perangkat)!")
        end
